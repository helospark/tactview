...
public class ClipToRightCommand implements UiCommand {
    ...
    private ClipToRightCommand(Builder builder) {
    ...
    public void execute() {
        ...
        TimelinePosition positionToMoveTo = firstClipToRight
                .map(a -> a.getInterval().getStartPosition().subtract(clip.getInterval().getLength()))
                .orElse(clip.getInterval().getStartPosition());
    ...
    public static final class Builder {
        ...
        public ClipToRightCommand build() {
            return new ClipToRightCommand(this);
        }
    }
}
