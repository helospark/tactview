...
public class StandardTransitionEffectConfiguration {
    ...
    public StandardEffectFactory alphaTransitionEffect(IndependentPixelOperation independentPixelOperation) {
        return StandardEffectFactory.builder()
                .withFactory(request -> new AlphaTransitionEffect(new TimelineInterval(request.getPosition(), TimelineLength.ofMillis(10000)), independentPixelOperation))
    ...
    public StandardEffectFactory floatOutTransitionEffect(IndependentPixelOperation independentPixelOperation) {
        return StandardEffectFactory.builder()
                .withFactory(request -> new FloatOutTransitionEffect(new TimelineInterval(request.getPosition(), TimelineLength.ofMillis(10000)), independentPixelOperation))
                .withName("Float out")
