...
public class StringProviderFactory extends AbstractKeyframeableEffectDesSerFactory<StringProvider> {
    ...
    @Override
    public StringProvider deserializeInternal(JsonNode data, StringProvider currentFieldValue) {
        return new StringProvider(ReflectionUtil.deserialize(data.get("interpolator"), StringInterpolator.class, currentFieldValue.stringInterpolator));
    }
