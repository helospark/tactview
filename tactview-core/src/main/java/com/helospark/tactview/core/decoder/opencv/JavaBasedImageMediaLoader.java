...
@Component
public class JavaBasedImageMediaLoader implements ImageMediaLoader {
    private BufferedImageToClipFrameResultConverter converter;
    private ScaleService scaleService;

    public JavaBasedImageMediaLoader(BufferedImageToClipFrameResultConverter converter, ScaleService scaleService) {
