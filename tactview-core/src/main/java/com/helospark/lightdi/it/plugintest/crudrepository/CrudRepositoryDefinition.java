...
public class CrudRepositoryDefinition extends DependencyDescriptor {

    @Generated("SparkTools")
    private CrudRepositoryDefinition(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CrudRepositoryDefinition build() {
            return new CrudRepositoryDefinition(this);
        }
    }
